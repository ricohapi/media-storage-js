(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["RicohAPIMStorage"] = factory();
	else
		root["RicohAPIMStorage"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.MStorage = __webpack_require__(1).MStorage;
	exports.AuthClient = __webpack_require__(1).AuthClient;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AuthClient = __webpack_require__(6).AuthClient;
	var axios = __webpack_require__(8);
	var fs = __webpack_require__(26);

	var MStorage = function () {
	  _createClass(MStorage, [{
	    key: '_req',
	    value: function _req(opt) {
	      var _this = this;

	      return new Promise(function (resolve, reject) {
	        _this._client.getAccessToken().then(function (token) {
	          var ropt = opt;
	          if (opt.headers) {
	  ...
	  function MStorage(client, params) {
	    _classCallCheck(this, MStorage);
	  ...
	  _createClass(MStorage, [{
	    ...
	    value: function connect() {
	      ...
	      return this._client.session(AuthClient.SCOPES.MStorage).then(function (result) {
	        _this2._token = result.accessToken;
	    ...
	    key: 'download',
	    value: function download(id, type) {
	      if (id === undefined) throw new Error('parameter error');
	      var rtype = type || 'stream';
	    ...
	    key: 'downloadTo',
	    value: function downloadTo(id, path) {
	      ...
	      return this._req(opt).then(function (ret) {
